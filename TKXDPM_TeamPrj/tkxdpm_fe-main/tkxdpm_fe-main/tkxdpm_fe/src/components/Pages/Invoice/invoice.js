...
import ReturnPage from '../Order/returnPage';
...
const Invoice = () => {
  ...
  const handlePayment = async () => {
    if(paymentMethod == "vnpay" || paymentMethod == "normal"){
      const totalMoney = (orderDetails.invoiceProductPrice + orderDetails.invoiceProductPrice / 10 + orderDetails.invoiceShippingFee)*1000;
